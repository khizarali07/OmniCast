        ...
        <div className="bg-surface-container-low/70 backdrop-blur-xl border border-outline-variant/30 rounded-xl p-8 shadow-[0_16px_64px_rgba(157,80,187,0.08)]">
          ...
          <form className="space-y-5" action={signup}>
            ...
            <div className="space-y-2">
              <label className="block font-label-caps text-label-caps text-on-surface-variant uppercase" htmlFor="fullName">Full Name</label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                  <span className="material-symbols-outlined text-outline-variant group-focus-within:text-primary transition-colors text-[20px]">person</span>
                </div>
                <input className="w-full bg-surface-dim border border-outline-variant/40 rounded-lg py-3 pl-11 pr-4 font-body-md text-body-md text-on-surface placeholder-outline focus:outline-none focus:border-primary-container focus:ring-1 focus:ring-primary-container transition-all duration-200" id="fullName" name="fullName" placeholder="John Doe" required type="text"/>
              </div>
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="font-body-sm text-body-sm text-on-surface-variant">
              ...
              <Link className="text-primary hover:text-primary-fixed font-medium transition-colors ml-1" href="/login">Sign in</Link>
            </p>
          </div>
        </div>
      </main>
